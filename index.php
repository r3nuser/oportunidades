		...
		<div class="caixa">
			<form name="Cadastro" action="ValidarComPHP.php" method="POST">
				...
				<div>
					...
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Administração de pequenos negócios"/>Administração de pequenos negócios</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Auxiliar de Departamento pessoal"/>Auxiliar de Departamento pessoal</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Balconista de Farmácia"/>Balconista de Farmácia</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Berçarista"/>Berçarista</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Como Organizar seu Evento"/>Como Organizar seu Evento</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Cuidador Infantil"/>Cuidador Infantil</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Excel Avançado"/>Excel Avançado</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Gestão de Rotinas Administrativas"/>Gestão de Rotinas Administrativas</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Gestão Financeiras de Empresa pequena e Médias Empresas"/>Gestão Financeiras de Empresa pequena e Médias Empresas</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Informática Básica"/>Informática Básica        </br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Informática para Concursos"/>Informática para Concursos</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Informática para Educadres"/>Informática para Educadres</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Informática Avançada"/>Informática Avançada      </br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Inglês Básico"/>Inglês Básico</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Introdução à Nova Legislação Trabalhista"/>Introdução à Nova Legislação Trabalhista</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Logística"/>Logística</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Operador de Caixa"/>Operador de Caixa</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Rede de Computadores"/>Rede de Computadores</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Secretaria Escolar"/>Secretaria Escolar</br>
					<input  onclick="escolheCurso()" type="radio" name="escolha" value="Segurança na Internet"/>Segurança na Internet</br>
					</br>
				</div>
				</br>
...
<!--Sobre a expectativa-->
				...
				<input 
					class="entrada"  
					type="text" 
					name="ExpectativaInput" 
					id="ExpectativaInput" 
					onblur="verify(this.value,'ExpectativaInput','expectativaError')"
					disabled
				/>
				...
				<input 
					class="entrada"  
					type="text" 
					name="discoveredTheCourseInput" 
					id="discoveredTheCourseInput" 
					onblur="verify(this.value,'discoveredTheCourseInput','discoveredTheCourseError')"
					disabled
				/>
				<br>
